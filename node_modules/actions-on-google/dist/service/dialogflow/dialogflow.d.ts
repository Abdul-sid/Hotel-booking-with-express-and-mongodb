...
export interface DialogflowMiddleware<TConversationPlugin extends DialogflowConversation<{}, {}, Contexts>> {
    ...
    /** @public */
    framework: BuiltinFrameworkMetadata): (DialogflowConversation<{}, {}, Contexts> & TConversationPlugin) | void | Promise<DialogflowConversation<{}, {}, Contexts> & TConversationPlugin> | Promise<void>;
}
/** @public */
